...
const Banner = () => {
  return (
    <>
      <div className="mt-24 hidden bg-primary relative p-3 md:flex  h-[60vh] items-center justify-between">
        <div className="text-background h-full  relative">
          <div className="text-5xl  max-w-lg    h-full flex flex-col items-center justify-between  font-bold">
            <div className="uppercase">Trustufull agency to hire a garden</div>
            <div className="text-lg font-normal">
              ...
              connecting homeowners with skilled and experienced gardeners who
              can bring your garden vision to life. With a commitment to quality
              and customer satisfaction, we are your reliable partner in
              achieving the garden you've always dreamed of.
            </div>
          </div>
        </div>
